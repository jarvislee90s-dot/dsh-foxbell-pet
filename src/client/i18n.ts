...
const ZH: Dict = {
  ...
  "dash.hitCompare": "命中率 {a}（上一周期 {b} · {d}）",
  "dash.hitCur": "命中率 {a}",
  ...
  "settings.tip.scale": "整体缩放精灵、状态卡、菜单与悬浮条；小 0.75× / 中 1× / 大 1.25×。",
  ...
  "settings.tip.approvalFlickerMin": "审批等待达到该分钟数且页面不在前台时，浏览器标签页标题会轮换显示「🦊 审批等待中…」召集你回来；0=关闭。",
  ...
  "settings.tip.summaryEnabled": "工作总结：任务完成后宠物旁出现「📖 总结」限时入口，点开小黑板查看本轮摘要（黑板内容为纯文字明细）。",
  "settings.tip.summaryEntrySec": "「📖 总结」入口出现后保留的秒数，超时自动消失。",
...
const EN: Dict = {
  ...
  "dash.hitCompare": "Hit rate {a} (previous period {b} · {d})",
  ...
  "settings.sect.core": "Core · Work status",
  ...
  "settings.tip.scale": "Scales the sprite, status cards, menu and mini bar together: small 0.75× / medium 1× / large 1.25×.",
  ...
  "settings.tip.approvalFlickerMin": "After an approval waits this many minutes while the page is hidden, the tab title alternates with \"🦊 approval waiting…\" to call you back; 0=off.",
  ...
  "settings.tip.summaryEnabled": "Work summary: after a task completes a \"📖 Summary\" entry appears by the pet, opening the blackboard digest.",
  "settings.tip.summaryEntrySec": "How long the \"📖 Summary\" entry stays before auto-dismissing.",
