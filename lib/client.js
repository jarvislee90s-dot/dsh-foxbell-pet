...
var ACTION_KEYS = ["doneAction", "dblAction", "approvalAction", "errorAction"];
var CFG_DEFAULT = {
  muted: false,
  talkative: true,
  doneAction: "jumping",
...
function SettingsCard() {
  ...
  const actionLabel = (a) => t(`action.${a}`);
  const scaleLabel = (s) => s === 0.75 ? t("scale.small") : s === 1 ? t("scale.medium") : t("scale.large");
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dyn-pet-settings", children: [
    ...
    ["dblAction", "approvalAction", "errorAction", "doneAction"].map((k) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dyn-pet-settings-row", children: [
...
function DialogHost() {
  ...
  switch (req.kind) {
    case "switch":
      return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(SwitchDialog, { onClose: closeDialog });
    case "import":
      return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ImportDialog, { onClose: closeDialog });
    case "manage":
      return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ManageDialog, { onClose: closeDialog });
    case "guard":
      return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(GuardDialog, { ...req.props, onClose: closeDialog });
    default:
      return null;
  }
}
