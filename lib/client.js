...
function SettingsCard() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("li", { className: "dyn-pet-card" + (open ? " open" : ""), children: [
    ...
    open ? /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "dyn-pet-card-body dyn-pet-settings", children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "dyn-pet-settings-section", children: t("settings.configSection") }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { className: "dyn-pet-settings-row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: t("settings.muted") }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("input", { type: "checkbox", checked: !draft.muted, onChange: (e) => setDraftKey("muted", !e.target.checked) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { className: "dyn-pet-settings-row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: t("settings.talkative") }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { className: "dyn-pet-settings-row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: t("settings.gravity") }),
      ...
      DASH_BOOL_KEYS.map((k) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { className: "dyn-pet-settings-row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: t(`dash.cfg.${k}`) }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("input", { type: "checkbox", checked: !!draft[k], onChange: (e) => setDraftKey(k, e.target.checked) })
      ] }, k)),
      DASH_NUM_ROWS.map((k) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { className: "dyn-pet-settings-row" + (isBadNumValue(draft[k]) ? " bad" : ""), children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: t(`dash.cfg.${k}`) }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { className: "dyn-pet-settings-row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: t("dash.cfg.dashboardSidebarEntry") }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "dyn-pet-settings-row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: t("dash.cfg.exportPose") }),
      ...
      ["dblAction", "approvalAction", "runningAction", "errorAction", "doneAction"].map((k) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "dyn-pet-settings-row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: t(`settings.${k}`) }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "dyn-pet-settings-row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: t("settings.scale") }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "dyn-pet-scale-group", children: CFG_SCALES.map((s) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
          "button",
          {
...
async function exportDashboardImage(input) {
  ...
  c.textAlign = "right";
  c.fillText(input.peakLabel, W - PAD, y + 26);
  c.textAlign = "left";
  ...
  if (input.models.length === 0) {
    ...
    for (const m of input.models) {
      ...
      c.fillText(m.name, PAD, y + 14);
      c.fillStyle = "#374151";
      c.font = "500 14px system-ui";
      c.textAlign = "right";
      c.fillText(m.val, W - PAD, y + 14);
      c.textAlign = "left";
  ...
  const bubbleLines = (() => {
    ...
    for (const ch of input.quote) {
      if (ch === "\n" || c.measureText(line + ch).width > bubbleW - 40) {
        lines.push(line);
        line = ch === "\n" ? "" : ch;
      } else line += ch;
    }
