...
function Board(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dyn-pet-board" + (props.mode === "farewell" ? " farewell" : ""), children: [
    ...
    u && Array.isArray(u.models) && u.models.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "dyn-pet-board-row dyn-pet-mini-dim", children: t("dash.models") + " " + u.models.slice(0, 3).map((m) => `${shortModel(m.model || m.route)} ${fmtTokens(m.requestTotal)}`).join(" \xB7 ") + (u.models.length > 3 ? " " + t("dash.moreN", { n: String(u.models.length - 3) }) : "") }) : null,
...
function Info({ text }) {
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "dyn-pet-info", title: text, "aria-label": text, tabIndex: 0, children: "i" });
}
