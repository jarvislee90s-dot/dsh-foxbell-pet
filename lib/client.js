...
var CFG_DEFAULT = {
  ...
  exportQuote: "",
  // v2.2 R8 导出评语模板（空=内置评语池；宿主 settings 同名键镜像）
  exportPose: "random"
...
function sanitizeValue(k, v) {
  ...
  if (k === "exportQuote") return typeof v === "string" ? v.slice(0, 2e3) : "";
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
      "div",
      {
        ...
        children: [
          ...
          miniMode !== null && board === null && !dragging && stateRef.current.drag === null ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dyn-pet-mini-wrap", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
            MiniBar,
            {
              dash: snap?.dashboard ?? null,
              cards,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
            "div",
            {
              ...
              onPointerLeave: () => {
                clearHoverTimer();
                if (miniMode === "hover") setMiniMode(null);
              },
              style: {
                width: frameW,
                height: frameH,
...
function SettingsCard() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("li", { className: "dyn-pet-card" + (open ? " open" : ""), children: [
    ...
    open ? /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "dyn-pet-card-body dyn-pet-settings", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { className: "dyn-pet-settings-row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: t("dash.cfg.exportQuote") }),
...
function drawTrend(c, points, x, y, w, h) {
...
async function exportDashboardImage(input) {
  ...
  c.fillText(input.title, 48, 64);
  c.font = "700 64px system-ui";
  c.fillText(input.hero, 48, 160);
  c.font = "400 15px system-ui";
  c.fillStyle = "#7a6a58";
  drawTrend(c, input.points, 48, 200, W - 96, 150);
  let y = 400;
  c.fillStyle = "#2b2b2b";
  for (const [k, v] of input.grid.slice(0, 4)) {
  ...
  y += 8;
  for (const m of input.models.slice(0, 3)) {
    c.font = "500 15px system-ui";
    c.fillText(`${m.name}  ${m.val}`, 48, y);
    y += 26;
  }
  ...
  roundRect(c, W - 560, H - 160, 440, 88, 16);
  c.fillStyle = "#ffffff";
  c.fill();
  c.fillStyle = "#4a3b2a";
...
function DashboardPanel() {
  ...
  const buildQuote = () => pickQuote({ total: hero, hitPct: hitRate, trendUp, multiModel: models.length > 1, loaf }, getLang(), cfg.exportQuote, quoteVars);
  ...
  const onExportImage = async () => {
    ...
    const blob = await exportDashboardImage({
      title: `${t("dash.panelTitle")} \xB7 ${t(`dash.tab.${tab}`)}`,
      hero: fmtTokens(hero),
      grid,
