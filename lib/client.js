...
function boardRows(s) {
  ...
  const rows = [
    ...
    { label: t("dash.boardToolsTop"), value: s.toolRows.length ? s.toolRows.map(toolEntry).join(" \xB7 ") : "\u2014" },
...
function Board(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dyn-pet-board" + (props.mode === "farewell" ? " farewell" : ""), children: [
    ...
    boardRows(s).map((kv, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dyn-pet-board-kv", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "k", children: kv.label }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "v", children: kv.value })
    ] }, i)),
...
function Pet(props) {
  ...
  (0, import_react2.useEffect)(() => petStore.subscribe(() => {
  ...
  const signTimerRef = (0, import_react2.useRef)(null);
  const paceTierRef = (0, import_react2.useRef)(null);
  const [miniMode, setMiniMode] = (0, import_react2.useState)(null);
  const hoverTimerRef = (0, import_react2.useRef)(null);
  const miniLeaveTimerRef = (0, import_react2.useRef)(null);
  ...
  const [board, setBoard] = (0, import_react2.useState)(null);
  const boardTimerRef = (0, import_react2.useRef)(null);
  const boardRef = (0, import_react2.useRef)(null);
  const openBoardRef = (0, import_react2.useRef)(() => {
  });
...
function SettingsCard() {
  ...
  const [draft, setDraft] = (0, import_react4.useState)(cfgStore.getSnapshot());
  const [savedFlash, setSavedFlash] = (0, import_react4.useState)(false);
  const dirtyRef = (0, import_react4.useRef)(false);
  (0, import_react4.useEffect)(() => cfgStore.subscribe(() => {
...
function DashboardPanel() {
  const snap = (0, import_react11.useSyncExternalStore)(appStore.subscribe, appStore.getSnapshot);
  const cfg = (0, import_react11.useSyncExternalStore)(cfgStore.subscribe, cfgStore.getSnapshot);
  const [tab, setTab] = (0, import_react11.useState)("7d");
  const [custom, setCustom] = (0, import_react11.useState)({ from: dayKey(new Date(Date.now() - 6 * 864e5)), to: dayKey(/* @__PURE__ */ new Date()) });
  const [range, setRange] = (0, import_react11.useState)(null);
  const [busy, setBusy] = (0, import_react11.useState)(false);
  const [rangeHint, setRangeHint] = (0, import_react11.useState)("");
  const [hover, setHover] = (0, import_react11.useState)(null);
  const [copiedFlash, setCopiedFlash] = (0, import_react11.useState)(false);
  const [quoteOpen, setQuoteOpen] = (0, import_react11.useState)(false);
  const [quoteDraft, setQuoteDraft] = (0, import_react11.useState)(() => {
    try {
  ...
  const [prevHit, setPrevHit] = (0, import_react11.useState)(null);
  const modelHeadRef = (0, import_react11.useRef)(null);
  ...
  const points = (0, import_react11.useMemo)(() => {
  ...
  const hero = (0, import_react11.useMemo)(() => points.reduce((s, p) => s + p.value, 0), [points]);
  ...
  const [modelNameW, setModelNameW] = (0, import_react11.useState)(200);
  const [modelValW, setModelValW] = (0, import_react11.useState)(84);
  (0, import_react11.useEffect)(() => {
...
function makeUseSessions(ctx) {
  ...
  return function useSessions(sel) {
    const [value, setValue] = import_react12.default.useState(() => ok ? sel(read()) : void 0);
...
function apply(ctx) {
  ...
  slots.inject(
    ...
    () => slots.register(
      ...
      (props) => import_react12.default.createElement(OverlayEntry, Object.assign({}, props, { ctx, useSessions }))
    )
  );
  slots.inject(
    ...
    () => slots.register(
      ...
      (props) => import_react12.default.createElement(PetToggle, props)
    )
  );
  slots.inject(
    ...
    () => slots.register(
      ...
      () => import_react12.default.createElement(SettingsCard)
    )
  );
  ...
  slots.inject(
    ...
    () => slots.register(
      ...
      () => import_react12.default.createElement(DashboardPanel)
    )
  );
}
var inject = ["slots"];
