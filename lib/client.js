  ...
  factory: (require) => {
    ...
    function adoptStyles() {
      ...
      style.textContent = `
        ...
        .dyn-pet-card { list-style: none; border: 1px solid rgba(0,0,0,0.10); border-radius: 12px; background: rgba(255,255,255,0.9); overflow: hidden; }
        .dyn-pet-card-head { all: unset; display: flex; align-items: center; gap: 10px; width: 100%; box-sizing: border-box; padding: 10px 14px; cursor: pointer; }
        .dyn-pet-card-head:hover { background: rgba(0,0,0,0.03); }
        .dyn-pet-card-titles { display: flex; flex-direction: column; align-items: flex-start; gap: 2px; margin-right: auto; min-width: 0; }
        .dyn-pet-card-title { font-weight: 600; font-size: 13.5px; color: #333; }
        .dyn-pet-card-desc { font-size: 11.5px; color: #999; }
        .dyn-pet-card-chevron { color: #999; font-size: 12px; transition: transform .15s ease; }
        .dyn-pet-card-chevron.open { transform: rotate(180deg); }
        .dyn-pet-settings { padding: 4px 14px 12px; padding-top: 0; border-top: 1px solid rgba(0,0,0,0.06); margin-top: 0; }
    ...
    function SettingsCard(props) {
      ...
      return React.createElement('li', { className: 'dyn-pet-card' },
        React.createElement('button', {
          type: 'button',
