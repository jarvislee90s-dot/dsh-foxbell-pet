...
function TrendChart(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("svg", { viewBox: `0 0 ${width} ${height}`, style: { width: "100%", height: "auto", display: "block" }, role: "img", children: [
    ...
    props.showLabels ? points.map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("text", { x: pts[i].x.toFixed(1), y: height - 3, textAnchor: i === 0 ? "start" : i === points.length - 1 ? "end" : "middle", fontSize: "9", fill: "currentColor", opacity: "0.6", children: p.label }, i)) : null
  ] });
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dyn-pet-board" + (props.mode === "farewell" ? " farewell" : ""), children: [
    ...
    u && Array.isArray(u.models) && u.models.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
      u.models.slice(0, 3).map((m, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dyn-pet-board-kv", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "v", children: `${m.model || m.route} ${fmtTokens(m.requestTotal)}` })
      ] }, m.route)),
...
function DashboardPanel() {
  ...
  const points = (0, import_react11.useMemo)(() => {
    ...
    if (range) return range.days.map((d) => ({ label: `${Number(d.key.slice(5, 7))}/${Number(d.key.slice(8, 10))}`, value: d.dayTotal, key: d.key, hitPct: d.hitPct }));
    return [];
  }, [tab, trend, range]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "dyn-pet-dash", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "dyn-pet-dash-card", children: [
      ...
      models.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "dyn-pet-dash-empty", children: t("dash.noData") }) : models.slice(0, 6).map((m) => /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "dyn-pet-dash-model", children: [
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "dyn-pet-dash-model-name", title: m.route, children: m.model || m.route }),
...
.dyn-pet-dash { padding: 20px 28px; overflow: auto; height: 100%; box-sizing: border-box; color: #3b2f23; font-size: 15px; line-height: 1.6; max-width: 1020px; margin: 0 auto; }
.dyn-pet-dash-head { display: flex; align-items: center; justify-content: space-between; gap: 8px; flex-wrap: wrap; }
.dyn-pet-dash-head h2 { margin: 0; font-size: 19px; font-weight: 700; color: #7a4a2b; }
...
.dyn-pet-dash-weekhit { font-size: 14px; color: #a07050; }
...
.dyn-pet-dash-row span { font-size: 15px; color: #6b7280; }
.dyn-pet-dash-row strong { font-size: 15px; font-weight: 600; color: #1f2937; font-variant-numeric: tabular-nums; }
...
.dyn-pet-dash-card-head { display: flex; align-items: center; justify-content: space-between; gap: 8px; margin-bottom: 8px; font-size: 16px; font-weight: 700; color: #7a4a2b; }
.dyn-pet-dash-meta { font-size: 13px; font-weight: 400; color: #a07050; }
...
.dyn-pet-dash-model { display: flex; align-items: center; gap: 12px; padding: 5px 0; font-size: 15px; }
...
.dyn-pet-dash-toolcell span { font-size: 13px; color: #6b7280; }
.dyn-pet-dash-toolcell strong { font-size: 16px; font-weight: 600; color: #1f2937; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.dyn-pet-dash-empty { color: #a07050; font-size: 12px; padding: 4px 0; }
.dyn-pet-dash-foot { color: #a07050; font-size: 13px; padding-top: 2px; }
